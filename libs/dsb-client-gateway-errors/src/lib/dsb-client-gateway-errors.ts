export enum DsbClientGatewayErrors {
  ...
  CHANNEL_FORCE_PAYLOAD_ENCRYPTION = 'CHANNEL::CHANNEL_FORCE_PAYLOAD_ENCRYPTION',
  CHANNEL_MISSING_PAYLOAD_ENCRYPTION = 'CHANNEL::CHANNEL_MISSING_PAYLOAD_ENCRYPTION',
