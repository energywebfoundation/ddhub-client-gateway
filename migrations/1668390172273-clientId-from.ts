...
export class clientIdFrom1668390172273 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ALTER TABLE IF EXISTS public.pending_acks ADD COLUMN "from" character varying default null;
      ALTER TABLE IF EXISTS public.pending_acks DROP CONSTRAINT IF EXISTS "PK_pending_acks";
